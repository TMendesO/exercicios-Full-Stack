...
<?php
  //pegar as informações
      if(isset($_POST["nometransportadora"])){
          ...
          $cep      = $_POST["cep"];
          $cnpj      = $_POST["cnpj"];
          $telefone = $_telefone["telefone"];
          $tID      = $_POST["transportadoraID"];
          
          //objeto parar alterar
        ...
        <main>  
            <div id="janela_formulario">
                <form action="alteracao.php" method="post">
                    ...
                    <input type="text" value="<?php echo utf8_encode($info_transportadora["nometransportadora"]) ?>" name="nometrasportadora" id="nometrasportadora">
